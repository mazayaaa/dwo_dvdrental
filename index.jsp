...
<li><a href="testpage.jsp?query=adw1">DWOADW1</a></li>
<li><a href="testpage.jsp?query=adw2">DWOADW2</a></li>
<li><a href="testpage.jsp?query=advwo">ADVENTUREWORK</a></li>
<li><a href="testpage.jsp?query=dvdrental">DVDRENTAL</a></li>
</ul>
